...
class Api_Model extends CI_Model
{
	...
	/*
	FUNCTION NAME : get_all_arrest_complaint_details
	it will retun all  get_all_arrest_complaint_details list*/
	public function get_all_arrest_complaint_details($id)
	{
		
		$sql="select * from arrest_complaint_details where arrest_complaint_category_id =$id ";
		$query=$this->db->query($sql);
		return $query->result_array();
	}
