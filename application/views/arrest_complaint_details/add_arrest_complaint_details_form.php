...
<div class="content card col-xs-6  col-xs-offset-3 " style="margin-top:50px;">
				...
				echo form_open("add_new_arrest_complaint_details", $attributes);
				?>
					...
					<div class='form-group'>
						...
						<span class='text-danger'><?php  echo form_error('arrest_complaint_category_id'); ?></span>
					</div>
				
					<div class='form-group'>
						<label><?php echo $this->arrest_complaint_details_label ?></label>
						 						
						<textarea class='form-control'  rows="5" name='arrest_complaint_details' ></textarea>
